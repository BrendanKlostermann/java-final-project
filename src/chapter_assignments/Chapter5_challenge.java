...
public class Chapter5_challenge implements TaskHandler {
    ...
    public void task1(Scanner in) {
        ...
        int position = InputUtility.getIntInRange("Please enter a position to enter it: ", 0, list.length - 1, in);
        // shift all values after position
    ...
    public void task2(Scanner in) {
        ...
        // print updated list
        Integer remove = InputUtility.getIntInRange("Which number would you like to delete: ", 0, list.length - 1, in);
        list[remove] = null;
        System.out.println(Arrays.toString(list));
